	    ...
	    JavaMail(TM) API 1.3.2 release
	    ------------------------------

Welcome to the JavaMail API 1.3.2 release!  This release includes
...
------------
  ...
  2. Set your CLASSPATH to include the "mail.jar" file obtained from 
     ...
     Assuming you unzipped javamail-1_3_2.zip in /u/me/download/ the
     following would work:

      export CLASSPATH=$CLASSPATH:/u/me/download/javamail-1.3.2/mail.jar:.
